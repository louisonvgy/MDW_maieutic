  ...
  return (
    <div className="p-8 flex flex-col gap-8" ref={containerRef}>
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        <KpiCard label="Directeurs distincts" value={stats.nbDirecteurs.toLocaleString('fr-FR')} color="violet" />
        <KpiCard label="Thèses co-dirigées" value={stats.nbCoDir.toLocaleString('fr-FR')} sub={`${stats.pctCoDir}% du corpus`} color="indigo" />
        <KpiCard label="Paires de co-directeurs" value={stats.nbPairs.toLocaleString('fr-FR')} color="emerald" />
        <KpiCard label="Directeurs multi-étab." value={stats.nbBridge} sub="actifs dans 2+ établissements" color="amber" />
      </div>
